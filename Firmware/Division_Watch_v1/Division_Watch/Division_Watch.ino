...
/*
Division Watch - LED, IMU wakeup, Bluetooth functionality
...
void loop() {
  if(Button0.released()) Serial.println("Button 0 released");
  if(Button1.released()) Serial.println("Button 1 released");
  if(Button3.released()) Serial.println("Button 3 released");
  if(Button4.released()) Serial.println("Button 4 released");
  if(Button5.released()) {
...
void ringTimer(float length){
  ...
  while((millis() - startTime) < length){
    ...
    float timeMS = millis() - startTime;
    int timeS = (int) timeMS / 1000.0;
    //if(timeS != lastTimeS){
      Serial.print(timeS);
      Serial.print(", ");
